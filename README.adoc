# Red Hat AMQ 7.2.1 OpenShift container image

NOTE: Extends link:https://github.com/jboss-container-images/jboss-amq-7-image[Red Hat AMQ 7.2.1 container image]
...
$ docker tag amq-broker-7-tech-preview/amq-broker-72-openshift:latest openshift-docker-ip:5000/broker/amq-broker-72-openshift:1.0
$ docker push openshift-docker-ip:5000/broker/amq-broker-72-openshift:1.0
```
