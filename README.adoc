...
$ docker tag amq-broker-7-tech-preview/amq-broker-71-openshift:latest openshift-docker-ip:5000/broker/amq-broker-71-openshift:1.0
$ docker push openshift-docker-ip:5000/broker/amq-broker-71-openshift:1.0
```