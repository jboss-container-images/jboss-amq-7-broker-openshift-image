# Red Hat AMQ 7.3.0 OpenShift container image

NOTE: Extends link:https://github.com/jboss-container-images/jboss-amq-7-broker-image[Red Hat AMQ 7.3.0 container image]
...
$ oc process -n broker -f templates/amq-broker-73-basic.yaml -p APPLICATION_NAME=broker-app -p AMQ_USER=<username> -p AMQ_PASSWORD=<amqpassword>  | oc create -n broker -f -
```
...
$ docker tag amq-broker-7/amq-broker-73-openshift:latest openshift-docker-ip:5000/broker/amq-broker-73-openshift:7.3
$ docker push openshift-docker-ip:5000/broker/amq-broker-73-openshift:1.3
```
