...
cp -p ${SOURCES_DIR}/openshift-ping-common-$VERSION.jar \
  ...
  ${SOURCES_DIR}/netty-tcnative-2.0.42.Final-redhat-00001-linux-s390_64-fedora.jar \
  ${SOURCES_DIR}/netty-tcnative-2.0.42.Final-redhat-00001-linux-ppcle_64-fedora.jar \
  ${DEST}/lib
